...
window.onclick = function(event) {
    ...
    const certificateModal4 = document.getElementById("certificateModal4");
    const certificateModal5 = document.getElementById("certificateModal5");
    ...
    } else if (event.target === certificateModal4) {
        closeModal("certificateModal4");
    } else if (event.target === certificateModal5) {
        closeModal("certificateModal5");
    }
};
